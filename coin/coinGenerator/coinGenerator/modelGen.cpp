			...
			for (int jj = -1; (bHeadNotFound || bHEyebrowsNotFound || bNoseNotFound) && (jj <= 1); ++jj)
			{
				for (int ii = -1; (bHeadNotFound || bHEyebrowsNotFound || bNoseNotFound) && (ii <= 1); ++ii)
				{
					if ((ii || jj) && ((i + ii) >= 0) && ((i + ii) < m_nWidth) && ((j + jj) >= 0) && ((j + jj) < m_nHeight))
					{
						...
						{
							m_pFacialComponentBoundaryMap[index] |= char(0b10000000);	//head������ �ٿ������ MSB�� 1�� ���� //unsigned char
						...
						{
							m_pFacialComponentBoundaryMap[index] |= char(0b01000000);	//����, �Լ�, ��� ������ �ٿ������ �ι�° ��Ʈ�� 1�� ���� //unsigned char
						...
						{
							m_pFacialComponentBoundaryMap[index] |= char(0b00100000);	//�� ������ �ٿ������ ����° ��Ʈ�� 1�� ���� //unsigned char
